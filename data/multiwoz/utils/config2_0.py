...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        # self.vocab_path_train = '../MultiWOZ_2.0/data/multi-woz-processed/vocab'
        self.vocab_path_eval = None
        self.data_path = '../MultiWOZ_2.0/multi-woz-processed/'
        self.data_file = 'data_for_damd.json'
        self.dev_list = '../MultiWOZ_2.0/valListFile.json'
        self.test_list = '../MultiWOZ_2.0/testListFile.json'
        self.dbs = {
            'attraction': '../MultiWOZ_2.0/db/attraction_db_processed.json',
            'hospital': '../MultiWOZ_2.0/db/hospital_db_processed.json',
            'hotel': '../MultiWOZ_2.0/db/hotel_db_processed.json',
            'police': '../MultiWOZ_2.0/db/police_db_processed.json',
            'restaurant': '../MultiWOZ_2.0/db/restaurant_db_processed.json',
            'taxi': '../MultiWOZ_2.0/db/taxi_db_processed.json',
            'train': '../MultiWOZ_2.0/db/train_db_processed.json',
        }
