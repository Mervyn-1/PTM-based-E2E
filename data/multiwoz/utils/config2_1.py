...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.data_path = '../MultiWOZ_2.1/multi-woz-processed/'
        self.data_file = 'data_for_damd.json'
        self.dev_list = '../MultiWOZ_2.1/valListFile.json'
        self.test_list = '../MultiWOZ_2.1/testListFile.json'
        self.dbs = {
            'attraction': '../MultiWOZ_2.1/db/attraction_db_processed.json',
            'hospital': '../MultiWOZ_2.1/db/hospital_db_processed.json',
            'hotel': '../MultiWOZ_2.1/db/hotel_db_processed.json',
            'police': '../MultiWOZ_2.1/db/police_db_processed.json',
            'restaurant': '../MultiWOZ_2.1/db/restaurant_db_processed.json',
            'taxi': '../MultiWOZ_2.1/db/taxi_db_processed.json',
            'train': '../MultiWOZ_2.1/db/train_db_processed.json',
        }
