...
def analysis(data_path, save_path, save_path_exp, data_file):
    compressed_raw_data = {}
    goal_of_dials = {}
    req_slots = {}
    info_slots = {}
    ...
    for fn, dial in data.items():
        ...
        for turn in logs:
            ...
            if fn in ['pmul2756.json', 'pmul4958.json', 'pmul3599.json'] or fn in ['pmul2756', 'pmul4958', 'pmul3599']:
                '''
                .json is for data.json, the first is for annotated_user_da_with_span_full.json (2.0)
                '''
                dial_type = 'single'
...
if __name__ == '__main__':
    ...
    save_path_exp = data_path + '/multi-woz-processed/'
    
    analysis(data_path, save_path, save_path_exp, data_file)