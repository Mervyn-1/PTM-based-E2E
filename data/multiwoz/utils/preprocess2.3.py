...
def get_db_values(value_set_path): # value_set.json, all the domain[slot] values in datasets
    ...
    with open('./data/MultiWOZ_2.1/ontology.json', 'r') as f: # read ontology in lower, all the domain-slot values
...
if __name__=='__main__':
    db_paths = {
            'attraction': 'data/MultiWOZ_2.1/attraction_db.json',
            'hospital': 'data/MultiWOZ_2.1/hospital_db.json',
            'hotel': 'data/MultiWOZ_2.1/hotel_db.json',
            'police': 'data/MultiWOZ_2.1/police_db.json',
            'restaurant': 'data/MultiWOZ_2.1/restaurant_db.json',
