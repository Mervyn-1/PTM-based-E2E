...
def dialog_turn_state_analysis(mode='train'):
    data_path = '../../data/dataset/multiwoz/MultiWOZ_2.0/multi-woz-processed/data_for_damd.json'
    conv_data = '../../data/dataset/multiwoz/MultiWOZ_2.0/annotated_user_da_with_span_full.json'
    ...
    with open('../../data/dataset/multiwoz/MultiWOZ_2.0/multi-woz-processed/multi_act_mapping_%s.json'%mode, 'w') as f:
