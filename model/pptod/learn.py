...
if __name__ == '__main__':
    ...
    from config.config_pptod import Config
    ...
    pretrained_model = args.pretrained_path if args.only_use_PLM is False else args.model_name
    if args.only_use_PLM:
        print('Only use PLM: {:s}'.format(args.model_name))
    model = T5Gen_Model(pretrained_model, data.tokenizer, data.special_token_list, dropout=args.dropout, 
