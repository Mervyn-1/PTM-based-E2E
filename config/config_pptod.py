...
class Config:
    ...
    def _multiwoz_damd_init(self):
        self.vocab_path_train = self.data_prefix + '/data/multi-woz-processed/vocab'
        self.data_path = self.data_prefix + '/data//multi-woz-processed/'
        self.data_file = 'data_for_damd.json'
        self.dev_list = self.data_prefix + '/data/multi-woz/valListFile.json'
        self.test_list = self.data_prefix + '/data/multi-woz/testListFile.json'
        ...
        self.domain_file_path = self.data_prefix + '/data/multi-woz-processed/domain_files.json'
