...
class _Config:
    def __init__(self):
        data_prefix = '../../data/dataset/multiwoz/MultiWOZ_2.0'
    ...
    def _multiwoz_damd_init(self):
        ...
        self.multi_acts_path = self.data_prefix +'/multi-woz-processed/multi_act_mapping_train.json'
        ...
        self.use_true_prev_bspn = True #ckpt给的f
        self.use_true_prev_aspn = True #ckpt给的f
        ...
        self.use_true_db_pointer = True #ckpt给的f
